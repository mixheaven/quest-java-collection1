...
public class Thanos {
    ...
    public static void main(String[] args) {
        ...
        Hero scarletWirch = new Hero("Scarlette Witch", 29);
        ...
        thor.setAge(1501);
        System.out.println(" I'm Thor, to day it's my birthday and i'm : " + thor.getAge());
